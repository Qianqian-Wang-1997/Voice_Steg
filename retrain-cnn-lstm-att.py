...
File_Embed = "./train_LPC/Emb"
File_NoEmbed = "./train_LPC/NoEmb"
...
if __name__ == '__main__':
    ...
    model_input = Input(shape=(int(SAMPLE_LENGTH/10), 3))  # PD = 2, LCP = 3
    ...
    print("Training")
    for i in range(ITER):
        checkpoint = ModelCheckpoint(filepath='testbest.hdf5',
